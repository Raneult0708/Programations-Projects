...
|---|---|---|
|Analyse|Définition des besoins|1 jour|
|Conception|Architecture + sécurité|1 jour|
|GUI|Interface Pygame|2 jours|
|Développement|Génération + chiffrement|2 jours|
|Tests|Sécurité et ergonomie|1 jour|
|Documentation|README + rapport|1 jour|
